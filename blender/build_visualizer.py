...
def _arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the TrackPrompt abstract Blender visualizer.")
...
def main() -> int:
    args = _arguments()
    result = build_scene(args.cues, args.audio, args.output, args.preset, args.seed)
