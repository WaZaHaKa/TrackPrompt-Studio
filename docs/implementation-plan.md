...
2. Implement streaming upload, bounded preflight plus visible-stage ffprobe validation, persistent lifecycle, SSE, cancellation, and explicit deletion. Timed analysis cleanup was later removed in favor of the persistent Analysis Library.
