...
export const promptPackage: PromptPackage = {
  ...
  factsUsed: ['rhythm.bpm', 'harmony.mode'],
  ...
  candidates: [{
    ...
    factsUsed: ['rhythm.bpm', 'structure.energyArc'],
...
export const fullCapabilities: Capabilities = {
  ...
  genreTagger: { id: 'clap', name: 'CLAP genre tagger', available: true, modelReady: true, modelId: 'laion/clap-htsat-unfused', effectiveDevice: 'cuda', taxonomyVersion: '1.0.0' },
...
export const analysis: AnalysisResult = {
  ...
  genreAnalysis: {
    ...
    descriptiveTags: [],
    windowEvidence: [{ id: 'w1', kind: 'middle', startSeconds: 1, endSeconds: 9, topLabels: ['electronic'], similarities: { electronic: 0.31 } }],
    sectionEvidence: {},
    confidence: 'medium',
  ...
  analyzerVersions: { 'trackprompt-core': '0.3.0' },
