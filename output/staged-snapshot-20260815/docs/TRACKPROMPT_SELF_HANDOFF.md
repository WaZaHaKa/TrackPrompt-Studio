...
R13 is a separate persistent look-development lock under `test-output/cinematic-v2-andromeda-r13-lookdev-20260722-201803/`. Its authoritative `variants-lock/` directory contains three protagonist options under fixed camera/lighting, a chamber construction module, a gate monolith, and approach/compression/post-crossing diagnostics, each at native 1080×1920 plus uncropped 180×320 phone size. The immutable proof-manifest SHA-256 is `ba0f13da116d6d13994c75bc58720153aae13c56147bc0373a6f8d168806365b`. Technical diagnostic flags are clear, but all four operator choices and human artistic approval remain pending. The 3-5 second motion test is therefore blocked and was not rendered; calibration, production authorization, cloud provisioning, future-act development, and full-track rendering remain out of scope.

R13.1 records protagonist B, weathered stone/metal/crystal v1, nested-ring monolith v1, and restrained teal/cyan/amber v1 as `selected-for-refinement`, never approved. The ignored proof root is `test-output/cinematic-v2-andromeda-r131-20260722-213840/`; its immutable proof SHA-256 is `acb896e9d445e2d0f7a187c3667dc22b01e91d9056644b510861e8b555685140`. One high-level MCP-authored 120-frame, 30 fps, native 1080×1920 motion proof covers independent approach, camera lag, foreground parallax, anticipation, ring alignment, localized compression, crossing, recovery, and seal onset. Structural, motion, encoding, exposure, and immutable-evidence checks pass. Codex recommends `REVISE`; human approval remains pending, `artistApproved` is false, and calibration/production remain blocked. R11, R12, and R13 evidence hashes were verified unchanged.
